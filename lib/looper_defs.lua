...
defs.OVERDUB_COL = 2
defs.FILTER_COL = 3
defs.STP_SPEED_COL = 4
defs.TAPE_WARBLE_COL = 5
defs.DROPPER_COL = 6
defs.JUMP_COL = 7
...
defs.LOOPER1_SELECT_KEY = {
  {9, 4}, {9, 5}, {9, 6}, {9, 7},
  {10, 6}, {10, 7}, {11, 7}, {12, 7}
}

defs.LOOPER2_SELECT_KEY = {
  {11, 2}, {12, 2}, {13, 2}, {13, 3},
  {14, 2}, {14, 3}, {14, 4}, {14, 5}
}

defs.LINK_PLAYHEADS_KEY = {
  {11, 4}, {11, 5}, {12, 4}, {12, 5}
}

defs.SEND_1_TO_2_KEY = {
  {8, 1}, {8, 2}, {8, 3}, {9, 1}, {9, 2}, {10, 1}
}

defs.SEND_2_TO_1_KEY = {
  {13, 8}, {14, 8}, {14, 7}, {15, 8}, {15, 7}, {15, 6}
}
...
defs.JUMP_TRIGGER_VALUES = {
  [4] = 4,  -- this button will aslo act as a toggle
  [3] = 8,  
  [2] = 16, 
  [1] = 32
}

defs.JUMP_TRIGGER_VALUES_SHIFT = {
  [4] = 3,
  [3] = 6,
  [2] = 12,
  [1] = 1000
